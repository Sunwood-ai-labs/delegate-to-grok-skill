...
The wrapper addresses four failure classes: PowerShell prompt argument splitting, missing or stale authentication, ambiguous command parameters, and concurrent session or OAuth use.

## Preserve the invocation contract
...
## Treat authentication as single-flight
